...
const AssetInventory = () => {
    ...
    const handleEditAsset = (assetId) => {
        ...
        // window.location.href = `/edit-asset?id=${assetId}`;
        ...
        <div className="bg-gray-100">
            ...
            <div className="container max-w-6xl mt-30 p-6 bg-gray-100 rounded-lg ml-40">
                ...
                <div className="text-right mb-6">
                    ...
                    <button className="bg-gray-200 text-gray-800 rounded px-4 py-2 ml-2">Search</button>
                    <button className="bg-gray-200 text-gray-800 rounded px-4 py-2 ml-2">Filter</button>
                </div>
